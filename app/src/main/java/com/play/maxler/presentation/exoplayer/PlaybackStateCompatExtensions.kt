...
inline val PlaybackStateCompat.isPauseEnabled
    get() = (actions and PlaybackStateCompat.ACTION_PAUSE != 0L) ||
            ((actions and PlaybackStateCompat.ACTION_PLAY_PAUSE != 0L) &&
                    (state == PlaybackStateCompat.STATE_BUFFERING || // 6
                            state == PlaybackStateCompat.STATE_PLAYING) // 3
                    )
...
/** not STATE_NONE -------> STATE_NONE This is the default playback state and indicates that no media has been added yet,
