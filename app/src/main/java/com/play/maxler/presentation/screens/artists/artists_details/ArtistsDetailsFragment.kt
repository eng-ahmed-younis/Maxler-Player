...
class ArtistsDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_artists_details, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ArtistsDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ArtistsDetailsFragment().apply {
